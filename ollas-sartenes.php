	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="row">
				    <h4 class="title_projects">Línea Agata</h4>
					<section id="projects">					
...
tamaños: 18, 20, 22, 24, 26 y 28 cm.<br>&raquo; Fácil de limpiar.<br>&raquo; No se pegan los alimentos.<br>&raquo; 2mm de espesor.'
						...
						producto(
							'Juego de Ollas SALCAR Agata <br>Antiadherente 8 piezas	',
						...
						producto(
							'Juego de Ollas SALCAR Agata <br>Antiadherente 9 piezas',
						...
						producto(
							'Juego de Ollas SALCAR Agata <br>Antiadherente 10 piezas',
					...
					<h4 class="title_projects">Línea Ebano</h4>
					<section id="projects">
					...
					<h4 class="title_projects">Línea Acero</h4>
					<section id="projects">
					...
					<h4 class="title_projects">Línea Onix</h4>
					<section id="projects">
						...
						// producto($title,$imgSmall,$imgBig,$description)
						producto(
							'Juego de ollas Salcar Onix <br>Antiadherente 7 piezas',
							'img/productos/ollas-sartenes/juego-de-ollas-7-piezas-onix.jpg',
							'',
							'<small>SAL-CWONIX07-NS</small><br>&raquo; Fácil de limpiar.<br>&raquo; No se pegan los alimentos.<br>&raquo; 1mm de espesor.'
							);											
                        producto(
							'Juego de ollas Salcar Onix  <br>Antiadherente 9 piezas',
							'img/productos/ollas-sartenes/juego-de-ollas-9-piezas-onix.jpg',
							'',
							'<small>SAL-CWONIX09-NS</small><br>&raquo; Fácil de limpiar.<br>&raquo; No se pegan los alimentos.<br>&raquo; 1mm de espesor.'
							);
                        producto(
							'Juego de 3 sartenes Salcar Onix Antiadherente',
							'img/productos/ollas-sartenes/juego-3-sart-salcar-onix-antiad.JPG',
							'',
							'<small>SAL-FPONIX03-NS</small><br>&raquo; Tamaños 18-22-24 cm.<br>&raquo; Fácil de limpiar.<br>&raquo; No se pegan los alimentos.<br>&raquo; 1mm de espesor.'
							);
                        producto(
							'Sartén doble Salcar <br>Onix Antiadherente',
							'img/productos/ollas-sartenes/sarten-doble-salcar-onix-antiad.jpg',
							'',
							'<small>SAL-FPONIX26-NS</small><br>&raquo; Tamaño 26 cm.<br>&raquo; Fácil de limpiar.<br>&raquo; No se pegan los alimentos.<br>&raquo; 1mm de espesor.'
							);                            
                        producto(
							'Sartén Salcar Onix Antiadherente <br>20-24-26 cm',
							'img/productos/ollas-sartenes/juego-3-sart-salcar-onix-antiad.JPG',
							'',
							'<small>SAL-FPONIX-NS</small><br>&raquo; Presentación individual en los siguientes tamaños: 20-24-26 cm.<br>&raquo; Fácil de limpiar.<br>&raquo; No se pegan los alimentos.<br>&raquo; 1mm de espesor.'
							);                        
                        producto(
							'Arrocera paellera Salcar <br>Onix Antiadherente',
							'img/productos/ollas-sartenes/arrocera-paellera-onix-28cm.jpg',
							'',
							'<small>SAL-PRONIX28-NS</small><br>&raquo; Tamaño 28 cm.<br>&raquo; Fácil de limpiar.<br>&raquo; No se pegan los alimentos.<br>&raquo; 1mm de espesor.'
							);
						?>						
					</ul>
					</section>					
					<h4 class="title_projects">Línea Aluminio</h4>
					<section id="projects">
						...
						// producto($title,$imgSmall,$imgBig,$description)
						producto(
							'Calderos Salcar Aluminio <br> 20-22-24-26-30-36 cm',
							'img/productos/ollas-sartenes/calderos-salcar-aluminio.jpg',
							'',
							'<small>SAL-CSALCAR-AL</small><br>&raquo; Presentación individual en los siguientes tamaños: 20-22-24-26-30-36 cm.'
							);											
                        producto(
							'Budare Salcar <br>Aluminio',
							'img/productos/ollas-sartenes/budare-salcar-aluminio-30cm.jpg',
							'',
							'<small>SAL-BSALCAR30-AL</small><br>&raquo; Tamaño 30 cm.'
							);
                        producto(
							'Arrocera Paellera Salcar Aluminio<br> Tamaño 36 cm.',
							'img/productos/ollas-sartenes/arrocera-paellera-salcar.jpg',
							'',
							'<small>SAL-PRSALCAR36-AL</small><br>&raquo; Tamaño 36 cm.'
							);
                        ?>						
					</ul>
					</section>
